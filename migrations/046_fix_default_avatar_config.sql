...
-- Updated to use correct options for pixel-art style
...
BEGIN
    ...
    -- Generate random avatar compatible with DiceBear v9
    v_random_avatar := jsonb_build_object(
        ...
        'eyes', (v_avatar_options->'eyes')->>(floor(random() * 30)::int),
        'mouth', (v_avatar_options->'mouth')->>(floor(random() * 30)::int),
        'clothing', 'variant01',
